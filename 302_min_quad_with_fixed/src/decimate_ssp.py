...
def decimate_ssp(Vo,Fo,num_target_vertices,ssp_maps,
    ...
    Optional inputs:
        ...
        print_every_iterations: scalar, how many iterations to print out the progress
        boundary_quadric_weight: scalar, weight on boundary quadrics
        boundary_quadric_regularization: scalar, regularization on quadric error, the higher the more uniform triangulation
    ...
    Qv = vertex_quadrics(V,F, twins, tips, 
                         boundary_quadric_weight = boundary_quadric_weight,
                         boundary_quadric_regularization = boundary_quadric_regularization)
    ...
    for he in range(nHe):
        if he_processed[he] == False:
            ...
            Qe = Qi + Qj
            v_opt, cost = optimal_location_and_cost(Qe)
    ...
    while True:
        ...
        for he_ in he_list_new:
            ...
            Qj_ = Qv[j_,:,:]
            v_opt_, cost_ = optimal_location_and_cost(Qi_+Qj_)
...
def vertex_quadrics(V,F, twins=None, tips=None, boundary_quadric_weight=1.0, boundary_quadric_regularization=1e-6):
    ...
    Inputs:
        ...
        boundary_quadric_regularization: scalar weight on regularizing boundaries
    Outputs:
